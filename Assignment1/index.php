  ...
  <header>
    <nav class="navbar navbar-dark bg-primary">
      <div class="container-fluid">
        <a class="navbar-brand" href="index.php"><img src="./img/clinic-logo.png" alt="header logo"></a>
	...
	<section class="masthead">
		<div>
			<h1>Puneet's Clinic</h1>
		</div>
	</section>
  <main class="container">
	   <section class="form-row row justify-content-center">
       <!-- the add.php will execute our CREATE function -->
		     <form method="post" action="view.php" class="form-horizontal col-md-6 col-md-offset-3">
          <!-- input values in table-->
           <p><input type="text" name="name" placeholder="Your Name"></p>
           <p><input type="number" name="patientid" placeholder="Your ID"></p>
           <p><input type="text" name="email" placeholder="Your email"></p>
           <p><input type="text" name="age" placeholder="Your Age"></p>
           <p><input type="text" name="bloodgroup" placeholder="Blood Group"></p>
           <p><input type="text" name="disease" placeholder="Disease"></p>
           <p><input type="text" name="treatmenttime" placeholder="Treatment Timeperiod(years)"></p>
